...
%    {\bf \makebox[2.3cm][l]{2023 -- 2024} Autonomy Staff Software Engineer}, BaseTrack, UAE
%    \begin{itemize}
%        \item[$\circ$] Maintenance and deployment of existing software stack
%            for autonomous trucks. Source code documentation, refactoring, and
%            evolution. [C++, python]
%    \end{itemize}
%
%    \vspace{0.15cm}
%
    {\bf \makebox[2.3cm][l]{2022 -- 2023} Reinforcement Learning Engineer}, Keybotic, remote
    \begin{itemize}
    ...
    {\bf \makebox[2.3cm][l]{2019 -- 2022} Senior Autonomy Engineer}, Sevendof, Norway
    \begin{itemize}
    ...
    {\bf \makebox[2.3cm][l]{2017 -- 2019} Software \& Control Engineer}, PAL Robotics, Spain
    \begin{itemize}
    ...
    {\bf \makebox[2.3cm][l]{2016 -- 2017} Research Engineer}, INRIA, France
    \begin{itemize}
    ...
    {\bf \makebox[2.3cm][l]{2012 -- 2016} Doctoral Student}, INRIA, France
    \begin{itemize}
    ...
    {\bf \makebox[2.3cm][l]{2012 -- 2012} Software Developer}, \"Orebro University, Sweden
    \begin{itemize}
    ...
    {\bf \makebox[2.3cm][l]{2009 -- 2010} System \& Network Administrator}, InfoLan LLC, Russia
    \begin{itemize}
